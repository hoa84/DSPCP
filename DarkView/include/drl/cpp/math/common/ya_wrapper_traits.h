/***************************************************************************
  ...
  Traits for wrappers base class
...
#ifndef YA_WRAPPER_TRAITS_H
#define YA_WRAPPER_TRAITS_H
  
YALANAMESPACE

template <class eltype, class mat_type>
class YA_Traits<YA_Wrapper<eltype,mat_type> > {
 public:
...
template <class eltype, class mat_type>
class YA_Traits<const YA_Wrapper<eltype,mat_type> > :
public YA_Traits<YA_Wrapper<eltype,mat_type> > { };
