...
#include "../../../../include/QT/QExtendedMainWindow.h"
...
static const char qt_meta_stringdata_QT__QExtendedMainWindow[] = {
...
const QMetaObjectExtraData QT::QExtendedMainWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QT::QExtendedMainWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_QT__QExtendedMainWindow,
      qt_meta_data_QT__QExtendedMainWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QT::QExtendedMainWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QT__QExtendedMainWindow))
